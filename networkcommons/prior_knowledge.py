...
def get_omnipath(genesymbols=True,
    ...
    if directed_signed:
        network = network[(network['consensus_direction'] is True) &
                          (
                              (
                                  (network['consensus_stimulation'] is True) &
                                  (network['consensus_inhibition'] is False)
                              ) |
                              (
                                  (network['consensus_stimulation'] is False) &
                                  (network['consensus_inhibition'] is True)
                              )
                          ) &
