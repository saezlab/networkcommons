...
import networkcommons  # noqa: E402

# -- Project information -----------------------------------------------------

project = 'networkcommons'
version = networkcommons.__version__
author = ', '.join(networkcommons.__author__)
years = '-'.join(sorted({'2022', f'{datetime.now():%Y}'}))
copyright = f'{years}, Saez Lab'
repository_url = 'https://github.com/saezlab/networkcommons'
